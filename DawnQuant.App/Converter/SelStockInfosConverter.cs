...
{
    [ValueConversion(typeof(CurSelStockItemInfo), typeof(SolidColorBrush))]
    public class SelStockInfosConverter:IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            var data = value as CurSelStockItemInfo;
